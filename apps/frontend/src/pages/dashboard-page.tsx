    ...
    <div className="space-y-6">
      {generalWarehouse ? (
        <article aria-label={generalWarehouse.name}>
          <Card className="overflow-hidden border-teal-200 bg-[linear-gradient(135deg,#ffffff_0%,#ecfeff_100%)]">
            ...
            <CardContent className="grid gap-5 px-6 pb-6 md:grid-cols-[1fr_auto] md:items-end">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-3">
                  <PackageCheck className="mb-2 h-4 w-4 text-emerald-700" />
                  <p className="text-xs text-emerald-900">Sem estoque</p>
                  <p className="text-xl font-semibold text-emerald-950">
                    {generalWarehouse.summary.outOfStockItems}
                  </p>
                </div>
                <div className="rounded-lg border border-amber-200 bg-amber-50 p-3">
                  <AlertTriangle className="mb-2 h-4 w-4 text-amber-700" />
                  <p className="text-xs text-amber-900">Alertas</p>
